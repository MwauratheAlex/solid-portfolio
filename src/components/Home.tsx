    ...
    <div class="py-2 text-gray-400 px-4 overflow-hidden">
      <Container>
        <div class='grid grid-cols-1 md:grid-cols-3 gap-4 md:w-4xl mx-auto'>
          ...
          >
            <div class="w-full">
              <pre class="font-semibold text-xl text-gray-600 tracking-wide py-2">
                Education
              </pre>
              <Education />
            </div>
          ...
          >
            <div class="w-full">
              <pre class="font-semibold text-xl tracking-wide text-gray-600 py-2">Experience</pre>
              <Experience />
            </div>
          </Animate>
          ...
          >
            <span class='space-y-2 md:w-min'>
              <div class='font-semibold text-lg md:text-2xl'>
                <pre class='whitespace-pre-wrap tracking-widest'>
                  Mbugua
                </pre>
              </div>
          ...
          >
            <div class='p-4 '>
              <pre class='font-semibold text-xl tracking-wide text-gray-600'>
                Technologies
              </pre>
                ...
                <For each={TECHNOLOGIES}>
                  {tech => (
                    <div class='daisy-btn daisy-btn-square grow bg-transparent daisy-tooltip' data-tip={tech.name}>
                      <tech.icon class={cn(tech.color, "opacity-70 size-8")} />
                    </div>
                  )}
                </For>
              </div>
  ...
  return (
    <li class="w-min">
      ...
      <div class="daisy-timeline-end md:mb-4">
        <div class="font-mono text-nowrap italic">{props.title}</div>
